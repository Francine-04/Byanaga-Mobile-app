...
export function businessProfileToRestaurant(profile) {
  ...
  return {
    ...
    category: 'Food',
    tags: [profile.categoryLabel, ...profile.services, ...profile.amenities, ...(profile.tags || [])],
...
export function businessProfileToDestination(profile) {
  ...
  return {
    ...
    bestTime: 'Plan ahead',
    tags: [profile.categoryLabel, ...profile.services, ...profile.amenities, ...(profile.tags || [])].filter(Boolean),
    latitude,
    longitude,
...
function normalizeDestination(id, data = {}) {
  ...
  return {
    ...
    tags: [destinationCategoryLabel(data.category || knownPlace?.category), data.clusterLabel, ...toStringList(data.tags), data.budget, data.travelStyle].filter(Boolean),
    latitude,
    longitude,
    visitCount,
...
function normalizeBusinessProfile(id, data = {}) {
  ...
  return {
    ...
    tags: [...toStringList(data.tags), data.budget, data.travelStyle].filter(Boolean),
    operatingHours: Array.isArray(data.operatingHours) ? data.operatingHours : [],
